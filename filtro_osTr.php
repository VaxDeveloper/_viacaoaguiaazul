    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET") {
            ...
            if (isset($_GET['coluna']) && isset($_GET['filtro'])) {
                ...
                $consulta_sql = "SELECT * FROM u219851065_AguiaAzul.ocorrencia_trafego WHERE $coluna LIKE '%$filtro%'";
            } else {
                // Caso contrário, consulta sem filtro
                $consulta_sql = "SELECT * FROM u219851065_AguiaAzul.ocorrencia_trafego";
            }
