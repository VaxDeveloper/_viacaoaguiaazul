...
<body>
    ...
    <div class="container">
        ...
        if (!isset($_SESSION['user']) || ($_SESSION['status'] != 1 && $_SESSION['status'] != 10 && $_SESSION['status'] != 11)) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET") {
            ...
            if (isset($_GET['coluna']) && isset($_GET['filtro'])) {
                ...
                $consulta_sql = "SELECT * FROM u219851065_AguiaAzul.ocorrencia_video WHERE $coluna LIKE '%$filtro%'";
            } else {
                // Caso contrário, consulta sem filtro
                $consulta_sql = "SELECT * FROM u219851065_AguiaAzul.ocorrencia_video";
            }
