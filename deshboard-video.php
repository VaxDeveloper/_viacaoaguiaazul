...
<body>
    ...
    <div class="container-logout Front-desk">
        <div class="container container-logout-content">
            <div class="font-monospace d-flex justify-content-between container-logout-values">
                <p class="font-monospace Front-desk" id="text-logout" style="height: auto;">Bem vindo, <?php echo $_SESSION['user']; ?>! você está logado em Deshboard - VÍDEO</p><a id="btn-logout" class="btn btn-info d-xl-flex align-items-xl-center" role="button" href="logout.php">SAIR</a>
            </div>
        </div>
    </div>
    <div class="d-flex" id="container-principal">
        ...
        <div class="container-dados" style="border-width: 1px; border-style: solid;">
            ...
            $consulta_sql = "SELECT * FROM u219851065_AguiaAzul.ocorrencia_video ORDER BY id DESC";
